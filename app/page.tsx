  ...
  offers: [
    {
      "@type": "Offer",
      name: "Starter",
      description: "Free forever. Ship your first production-ready site.",
      price: "0",
      priceCurrency: "USD",
      url: `${siteUrl}/new`,
    ...
    },
    {
      "@type": "Offer",
      name: "Studio (monthly)",
      description: "Unlimited projects with continuous iteration.",
      price: "29",
      priceCurrency: "USD",
      priceSpecification: {
    ...
    },
    {
      "@type": "Offer",
      name: "Studio (annual)",
      description: "Same plan, billed annually -- save 20%.",
      price: "276",
      priceCurrency: "USD",
      priceSpecification: {
        "@type": "UnitPriceSpecification",
